...
public class UserService implements UserServiceInterface {
    ...
    private final EmailServiceInterface emailServiceInterface;  // Service for sending emails

    @Autowired
    public UserService(UserMapper userMapper, SecurityUtil securityUtil, EmailServiceInterface emailServiceInterface) {
