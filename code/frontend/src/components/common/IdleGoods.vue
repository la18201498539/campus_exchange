<template>
	<div class="main-border">
        ...
        <span class="app-title">
			...
			<el-menu-item @click="status=1" index="1">Active Listings</el-menu-item>
			<el-menu-item @click="status =2" index="2">inactive Listings</el-menu-item>
		</el-menu>
			...
			<el-table-column label="operation">
				<template slot-scope="scope">
					<el-button
						size="mini"
						type="danger"
						@click="makeOfflineGoods(scope.$index)">Illegal Listings
					</el-button>
				</template>
			</el-table-column>
		</el-table>
			...
			<el-table-column label="operation">
				<template slot-scope="scope">
					<el-button
						size="mini"
						type="danger"
						@click="deleteGoods(scope.$index)">Delete Permanently
					</el-button>
				</template>
			</el-table-column>
		</el-table>
