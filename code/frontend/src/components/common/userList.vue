          ...
          <span v-show="this.mode != 3" class="app-title">
            ...
            <div v-show="this.mode ==3" class="addAdminButton">
                ...
                <el-dialog
                    ...
                    <el-input v-model="adminName"  maxlength="8" placeholder="Enter name" style="padding: 10px 0" clearable required></el-input>
                    <span style="margin-left: 10px">Username</span>
                    <el-input v-model="adminAccount" minlength="8" maxlength="10" placeholder="Enter username" style="padding: 10px 0"
                               clearable required></el-input>
                    <span style="margin-left: 10px">Password</span>
                    <el-input v-model="adminPassword" minlength="8" placeholder="Enter password" style="padding: 10px 0" show-password required></el-input>
                    <span style="margin-left: 10px">Confirm Password</span>
                    <el-input v-model="adminRePassword" minlength="10" placeholder="Enter password again" style="padding: 10px 0" show-password required></el-input>
            ...
            <el-table-column label="operation">
                <template slot-scope="scope">
                    <el-button
                            size="mini"
                            type="danger"
                            @click="sealUser(scope.$index)">Suspend</el-button>
                </template>
            </el-table-column>
        </el-table>
            ...
            <el-table-column label="operation">
                <template slot-scope="scope">
                    <el-button
                            size="mini"
                            type="success"
                            @click="unsealUser(scope.$index)">Unsuspend</el-button>
                </template>
            </el-table-column>
        </el-table>
