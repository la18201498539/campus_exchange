        ...
        <app-body>
            <div style="min-height: 85vh">
                <div style="margin: 0 20px; padding-top: 20px">
                    <div style="text-align: center; color: #555555; padding: 20px" v-if="idleList.length === 0">No matching items</div>
                    <el-row :gutter="30">
...
export default {
    ...
    created() {
        this.findIdleTime(1, this.$route.query.searchValue);
        this.searchValue = this.$route.query.searchValue;
    },
    watch: {
        $route(to, from) {
            this.searchValue = to.query.searchValue;
            this.findIdleTime(to.query.page, to.query.searchValue);
        }
    },
    methods: {
        findIdleTime(page, findValue) {
            this.$api
                .findIdleTime({
                    page: page,
                    nums: 8,
