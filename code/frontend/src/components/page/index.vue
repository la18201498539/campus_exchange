    ...
    <div>
        ...
        <app-body>
            ...
            <el-tabs v-model="labelName" type="card" @tab-click="handleClick">
                ...
                <el-tab-pane label="Electronics" name="1"></el-tab-pane>
                <el-tab-pane label="Life Goods" name="2"></el-tab-pane>
                <el-tab-pane label="Sports" name="3"></el-tab-pane>
                <el-tab-pane label="Books and notes" name="4"></el-tab-pane>
                <el-tab-pane label="Billboard" name="5"></el-tab-pane>
            </el-tabs>
