                    ...
                    <div class="details-header-user-info">
                        ...
                        <div style="margin-left: 10px">
                            ...
                            <div class="details-header-user-info-time">
                                {{ idleItemInfo.user.signInTime.substring(0, 10) }} joined platform
                            </div>
                        </div>
                    </div>
                    <div class="details-header-buy" :style="'width:' + (isMaster ? '150px;' : '280px;')">
                        <div v-show="idleItemInfo.idlePrice !== 0" style="color: red; font-size: 18px; font-weight: 600">
                    ...
                    <div class="message-send">
                        <div v-if="isReply" style="padding-bottom: 10px">
                            <el-button type="info" @click="cancelReply"
                                >Reply：{{ replyData.toMessage }} @{{ replyData.toUserNickname }}
