        ...
        <app-body>
            <div class="idle-details-container">
                <div class="details-header">
                    <div class="details-header-user-info">
                        ...
                        <div style="margin-left: 10px;">
                            ...
                            <div class="details-header-user-info-time">{{idleItemInfo.user.signInTime.substring(0,10)}} Join Platform</div>
                        </div>
                    </div>
                    <div class="details-header-buy" :style="'width:'+(isMaster?'150px;':'280px;')">
                        ...
                        <div v-if="!isMaster&&idleItemInfo.idleStatus!==1" style="color: red;font-size: 16px;">Item has been removed or deleted. </div>
                        <el-button v-show="idleItemInfo.idlePrice > 0" v-if="!isMaster&&idleItemInfo.idleStatus===1" type="danger" plain @click="buyButton(idleItemInfo)">Purchase</el-button>
                        <el-button v-show="idleItemInfo.idlePrice > 0" v-if="!isMaster&&idleItemInfo.idleStatus===1" type="primary" plain @click="favoriteButton(idleItemInfo)">{{isFavorite?'Cancel cart':'Add to cart'}}</el-button>
                        <el-button v-if="isMaster&&idleItemInfo.idleStatus===1" type="danger" @click="changeStatus(idleItemInfo,2)" plain>Withdraw this listing</el-button>
                        <el-button v-if="isMaster&&idleItemInfo.idleStatus===2" type="primary" @click="changeStatus(idleItemInfo,1)" plain>Activate this listing</el-button>
                    </div>
                </div>
                ...
                <div class="message-container" id="replyMessageLocation">
                    <div class="message-title">All messages</div>
                    <div class="message-send">
                        <div v-if="isReply" style="padding-bottom: 10px;">
                            <el-button type="info" @click="cancelReply">Reply：{{replyData.toMessage}} @{{replyData.toUserNickname}} <i class="el-icon-close el-icon--right"></i></el-button>
                        </div>
                        <el-input
                                type="textarea"
                                autosize
                    ...
                    <div>
                        <div v-for="(mes,index) in messageList" class="message-container-list">
                            ...
                            <div class="message-container-list-right">
                                <el-button style="float: right;"  plain @click="replyMessage(index)">Reply</el-button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                if(content){
                    ...
                    this.$api.sendMessage({
                        ...
                        if(res.status_code===1){
                            ...
                            this.$message.error("Comment failed!"+res.msg);
                        }
                    }).catch(()=>{
                    ...
                    this.$message.error("Comment is null!");
                }
            }
        },
    }
