    ...
    <div>
        ...
        <app-body>
            <div class="release-idle-container">
                <div class="release-idle-container-title">Post Idle/Announcement</div>
                <div class="release-idle-container-form">
                    <el-input placeholder="Please enter idle/announcement title" v-model="idleItemInfo.idleName"
                              maxlength="30"
                              show-word-limit>
                    </el-input>
                    <el-input
                            ...
                            type="textarea"
                            autosize
                            placeholder="Please enter a detailed description of the idle/announcement..."
    ...
    export default {
        ...
        methods: {
            ...
            handleExceed(files, fileList) {
                this.$message.warning(`Limit 10 pictures, selected ${files.length} pictures this time, total ${files.length + fileList.length} pictures selected`);
            },
            isNotice() {
